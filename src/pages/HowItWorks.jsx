...
const HowItWorks = () => {
  ...
  const steps = [
    {
      icon: FiPackage,
      title: getTranslation(language, 'howItWorks.steps.0.title'),
      description: getTranslation(language, 'howItWorks.steps.0.desc'),
      image: 'https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1751590603069-64b2b3c3-7cfb-40b7-973b-c0fb7b8c4d29.jpg'
    },
    {
      icon: FiCoffee,
      title: getTranslation(language, 'howItWorks.steps.1.title'),
      description: getTranslation(language, 'howItWorks.steps.1.desc'),
      image: 'https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1751590610247-19c9e199-802f-4400-9278-63d7b70976d3.jpg'
    },
    {
      icon: FiSmile,
      title: getTranslation(language, 'howItWorks.steps.2.title'),
      description: getTranslation(language, 'howItWorks.steps.2.desc'),
      image: 'https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1751590603069-64b2b3c3-7cfb-40b7-973b-c0fb7b8c4d29.jpg'
    },
    {
      icon: FiRefreshCw,
      title: getTranslation(language, 'howItWorks.steps.3.title'),
      description: getTranslation(language, 'howItWorks.steps.3.desc'),
      image: 'https://quest-media-storage-bucket.s3.us-east-2.amazonaws.com/1751590610247-19c9e199-802f-4400-9278-63d7b70976d3.jpg'
    }
  ];
          ...
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-green-500">
                {' '}{getTranslation(language, 'howItWorks.highlight')}
              </span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 50 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              {getTranslation(language, 'howItWorks.ctaTitle')}
            </h2>
            <p className="text-xl text-white mb-8">
              {getTranslation(language, 'howItWorks.ctaDesc')}
            </p>
            <motion.button
